...
/** Baut ein 1-seitiges A4-PDF:
 *  - legt PNG/JPG als Vollseiten-Hintergrund
 *  - schreibt Text laut Mapping
 */
export async function fillImageTemplate(
  ...
  // pdf-lib returns a Uint8Array whose underlying buffer may be ArrayBuffer or
  // SharedArrayBuffer depending on environment. TypeScript's lib types can
  // complain about ArrayBufferLike vs ArrayBuffer. Cast to BlobPart to satisfy
